...
public:
    ...
    QWidget *page_filesOperation;
    QPushButton *pushButton_filesOperation_openFiles;
    QPushButton *pushButton_filesOperation_mergeFiles;
    QPushButton *pushButton_filesOperation_clear;
    QTextEdit *textEdit_filesOperationInfo;
    QPushButton *pushButton_filesOperation_clearFiles;
    QLabel *label_filesOperation_frameSize;
    QLineEdit *lineEdit_filesOperation_filesNum;
    QPushButton *pushButton_filesOperation_sendFileInfo;
    QPushButton *pushButton_sendAndReceive;
    QPushButton *pushButton_filesTransmit;
    QPushButton *pushButton_firmwareUpgrade;
    QPushButton *pushButton_filesOperation;
    QMenuBar *menuBar;
    QMenu *menu;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        progressBar_firmwareUpgrade->setFont(font);
        ...
        page_filesOperation = new QWidget();
        page_filesOperation->setObjectName(QStringLiteral("page_filesOperation"));
        pushButton_filesOperation_openFiles = new QPushButton(page_filesOperation);
        pushButton_filesOperation_openFiles->setObjectName(QStringLiteral("pushButton_filesOperation_openFiles"));
        pushButton_filesOperation_openFiles->setGeometry(QRect(160, 470, 161, 51));
        pushButton_filesOperation_mergeFiles = new QPushButton(page_filesOperation);
        pushButton_filesOperation_mergeFiles->setObjectName(QStringLiteral("pushButton_filesOperation_mergeFiles"));
        pushButton_filesOperation_mergeFiles->setGeometry(QRect(160, 530, 161, 51));
        pushButton_filesOperation_clear = new QPushButton(page_filesOperation);
        pushButton_filesOperation_clear->setObjectName(QStringLiteral("pushButton_filesOperation_clear"));
        pushButton_filesOperation_clear->setGeometry(QRect(10, 340, 75, 23));
        textEdit_filesOperationInfo = new QTextEdit(page_filesOperation);
        textEdit_filesOperationInfo->setObjectName(QStringLiteral("textEdit_filesOperationInfo"));
        textEdit_filesOperationInfo->setGeometry(QRect(10, 10, 591, 331));
        pushButton_filesOperation_clearFiles = new QPushButton(page_filesOperation);
        pushButton_filesOperation_clearFiles->setObjectName(QStringLiteral("pushButton_filesOperation_clearFiles"));
        pushButton_filesOperation_clearFiles->setGeometry(QRect(330, 490, 81, 23));
        label_filesOperation_frameSize = new QLabel(page_filesOperation);
        label_filesOperation_frameSize->setObjectName(QStringLiteral("label_filesOperation_frameSize"));
        label_filesOperation_frameSize->setGeometry(QRect(326, 470, 51, 16));
        lineEdit_filesOperation_filesNum = new QLineEdit(page_filesOperation);
        lineEdit_filesOperation_filesNum->setObjectName(QStringLiteral("lineEdit_filesOperation_filesNum"));
        lineEdit_filesOperation_filesNum->setGeometry(QRect(380, 470, 31, 16));
        pushButton_filesOperation_sendFileInfo = new QPushButton(page_filesOperation);
        pushButton_filesOperation_sendFileInfo->setObjectName(QStringLiteral("pushButton_filesOperation_sendFileInfo"));
        pushButton_filesOperation_sendFileInfo->setGeometry(QRect(160, 590, 161, 51));
        stackedWidget->addWidget(page_filesOperation);
        ...
        pushButton_sendAndReceive->setGeometry(QRect(20, 470, 141, 51));
        ...
        pushButton_filesTransmit->setGeometry(QRect(20, 520, 141, 51));
        ...
        pushButton_firmwareUpgrade->setGeometry(QRect(20, 590, 141, 31));
        pushButton_firmwareUpgrade->setBaseSize(QSize(0, 0));
        pushButton_filesOperation = new QPushButton(centralWidget);
        pushButton_filesOperation->setObjectName(QStringLiteral("pushButton_filesOperation"));
        pushButton_filesOperation->setGeometry(QRect(20, 570, 141, 21));
        pushButton_filesOperation->setBaseSize(QSize(0, 0));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_filesOperation_openFiles->setText(QApplication::translate("MainWindow", "\346\211\223\345\274\200\346\226\207\344\273\266", Q_NULLPTR));
        pushButton_filesOperation_mergeFiles->setText(QApplication::translate("MainWindow", "\345\220\210\345\271\266\344\277\235\345\255\230", Q_NULLPTR));
        pushButton_filesOperation_clear->setText(QApplication::translate("MainWindow", "\346\270\205\347\251\272\347\252\227\345\217\243", Q_NULLPTR));
        pushButton_filesOperation_clearFiles->setText(QApplication::translate("MainWindow", "\346\270\205\347\251\272\346\226\207\344\273\266", Q_NULLPTR));
        label_filesOperation_frameSize->setText(QApplication::translate("MainWindow", " \346\226\207\344\273\266\346\225\260:", Q_NULLPTR));
        lineEdit_filesOperation_filesNum->setText(QApplication::translate("MainWindow", "0", Q_NULLPTR));
        pushButton_filesOperation_sendFileInfo->setText(QApplication::translate("MainWindow", "\346\223\246\351\231\244\346\227\247\345\255\227\345\272\223\357\274\214\345\207\206\345\244\207\346\233\264\346\226\260", Q_NULLPTR));
        ...
        pushButton_filesTransmit->setText(QApplication::translate("MainWindow", "\346\226\207\344\273\266\344\274\240\350\276\223(\346\227\240\345\217\215\351\246\210)", Q_NULLPTR));
        pushButton_firmwareUpgrade->setText(QApplication::translate("MainWindow", "\345\233\272\344\273\266\345\215\207\347\272\247(\346\234\211\345\217\215\351\246\210)", Q_NULLPTR));
        pushButton_filesOperation->setText(QApplication::translate("MainWindow", "\346\226\207\344\273\266\346\223\215\344\275\234(\345\220\210\345\271\266\346\226\207\344\273\266)", Q_NULLPTR));
